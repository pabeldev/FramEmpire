...
export default function TeamCaptainSection() {
  return (
    <section id="captain" className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-[#070913] relative border-t border-cyan-500/20 overflow-hidden">
      ...
      <div className="glow-orb-cyan top-10 left-10 opacity-30 pointer-events-none" />
      <div className="glow-orb-blue bottom-10 right-10 opacity-30 pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto space-y-8 sm:space-y-12 relative z-10">
        ...
        <div className="rounded-3xl p-6 sm:p-10 lg:p-12 transition-all duration-500 relative overflow-hidden bg-[#070a14] border border-cyan-500/20 shadow-[16px_16px_36px_#030409,-16px_-16px_36px_#0b101f]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-5 flex flex-col items-center text-center space-y-4">
              ...
              <div className="relative group">
                {/* Neumorphic Outer Circular Ring */}
                <div className="w-48 h-48 sm:w-60 sm:h-60 rounded-full p-2.5 bg-[#070a14] shadow-[10px_10px_25px_#030409,-10px_-10px_25px_#0b101f] border border-cyan-500/30 transition-transform duration-500 group-hover:scale-105">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="p-5 sm:p-6 rounded-2xl bg-[#060812] shadow-[inset_6px_6px_14px_#030409,inset_-6px_-6px_14px_#0b101f] border border-slate-800/80 space-y-3">
                ...
                <p className="text-xs sm:text-sm text-slate-300 leading-relaxed font-medium">
                  <strong>A M Pabel</strong> is a skilled graphic designer, animator, and digital content creator based in Dhaka, Bangladesh. He operates his professional portfolio through his official site <a href="https://ampabel.com" target="_blank" rel="noopener noreferrer" className="text-cyan-300 underline font-bold hover:text-cyan-200">ampabel.com</a> and frequently shares design insights within the creative community.
                </p>
              </div>

              {/* Core Skill Disciplines Badges */}
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                <div className="p-3 rounded-xl bg-[#070a14] shadow-[4px_4px_10px_#030409,-4px_-4px_10px_#0b101f] border border-cyan-500/20 flex items-center gap-2.5">
                ...
                <div className="p-3 rounded-xl bg-[#070a14] shadow-[4px_4px_10px_#030409,-4px_-4px_10px_#0b101f] border border-blue-500/20 flex items-center gap-2.5">
                ...
                <div className="p-3 rounded-xl bg-[#070a14] shadow-[4px_4px_10px_#030409,-4px_-4px_10px_#0b101f] border border-purple-500/20 flex items-center gap-2.5 col-span-2 sm:col-span-1">
              ...
              {/* Neumorphic Action Links */}
              <div className="flex flex-wrap items-center gap-3 pt-2">
                <a
                  href="https://ampabel.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-cyan-400 to-blue-600 text-black font-extrabold text-xs shadow-[0_0_20px_rgba(0,243,255,0.3)] hover:scale-105 transition-transform flex items-center gap-2"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-4 py-2.5 rounded-xl bg-[#070a14] text-cyan-300 font-bold text-xs shadow-[6px_6px_14px_#030409,-6px_-6px_14px_#0b101f] border border-cyan-500/30 hover:border-cyan-400 transition-all flex items-center gap-2"
                >
